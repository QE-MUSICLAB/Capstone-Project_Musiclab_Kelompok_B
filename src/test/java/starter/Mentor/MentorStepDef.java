...
////////////////////////////////////////////// GET ALL MENTOR
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR + "/GetAllMentorWithOutPathSchema.json");
    SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
...
//////////////////////////////////// GET MENTOR PROFILE BY ID
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR + "/GetMentorProfileByIndInvalidPathScehma.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
...
///////////////////////////////////////////////////////////GET MENTOR TOP WEEK
    ...
    public void validateGetMentorValidPathWithJsonSchemaValidator() {
    File json = new File(Constants.JSON_SCHEMA_MENTOR + "/GetMentorProfileByInvalidPathScehma.json");
    SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));}
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR+ "/GetMentorTopWeekInvalidPathSchema.json");
    SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
////////////////////////////////////////////////GET MENTOR TOP PROFILE
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR+ "/GetMentorProfileInvalidPathSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
///////////////////////////////////////////////PUT EDIT MENTOR PROFILE
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR+ "/PutEditMentorProfileWithEmptyValueSchema.json");
    SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
...
//////////////////////////////////////////////////////PUT EDIT PASSWORD MENTORS
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR + "/PutEditPasswordMentorInvalidReqSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    File json = new File(Constants.JSON_SCHEMA_MENTOR + "/PutEditPasswordMentorEmptyPassSchema.json");
    SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void sendRequestBodyForCreateMentorCredentials() {
    SerenityRest.when().post(MentorAPI.POST_CREATE_CREDENTIALS);
    }
//////////////////////////////////////////////////POST CREATE CREDENTIALS
    @When("Post create user with certificate_file {string}, type is {string},name is {string}")
    public void postCreateUserWithCertificate_fileTypeIsNameIsImagesIs(String certificate_file, String type, String name) {
    mentorAPI.setPostCreateCredentials(certificate_file, type, name);
    }

/////////////////////////////////////////////DELETE MENTOR
    @When("Delete mentor with valid path")
    public void deleteMentorWithValidPath() {

}

    @And("Send DELETE request for delete mentor")
    public void sendDELETERequestForDeleteMentor() {
     SerenityRest.when().delete(MentorAPI.DELETE_MENTOR);
    }

    @When("Delete mentor with invalid path")
    public void deleteMentorWithInvalidPath() {
    mentorAPI.setDeleteMentorInvalid();
    }
    @And("Send DELETE request for delete mentor with invalid path")
    public void sendDELETERequestForDeleteMentorInvalid() {
     SerenityRest.when().delete(MentorAPI.DELETE_MENTOR_INVALID);
    }

    @And("Validate delete mentor using invalid path with json schema validator")
    public void validateDeleteMentorUsingInvalidPathWithJsonSchemaValidator() {
    File json = new File(Constants.JSON_SCHEMA_MENTOR + "/DeleteMentorInvalidSchema.json");
    SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void validateGetMentorTopWeekWithJsonSchemaValidator() {
        File json = new File(Constants.JSON_SCHEMA_MENTOR + "/GetMentorTopWeekSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
}
